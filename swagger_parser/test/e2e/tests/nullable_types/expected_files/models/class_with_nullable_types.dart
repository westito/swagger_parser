...
class ClassWithNullableTypes with _$ClassWithNullableTypes {
  const factory ClassWithNullableTypes({
    ...
    @JsonKey(name: 'p3_list') required Object0? p3List,
